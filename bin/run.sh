...
# RUNTIME
SELF_JAR=../target/bdcs-pregel-1.0-SNAPSHOT-shaded.jar
...
PREGEL=edu.snu.bdcs.reef.pregel.PregelREEF

CMD="java -cp $YARN_CONF_DIR:$SELF_JAR:$CLASSPATH $LOCAL_RUNTIME_TMP $LOGGING_CONFIG $PREGEL $*"
echo $CMD
$CMD # 2> /dev/null
